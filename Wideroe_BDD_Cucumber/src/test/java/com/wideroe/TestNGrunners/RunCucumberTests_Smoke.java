package com.wideroe.TestNGrunners;
...
@CucumberOptions(
		...
		glue = { "com.wideroe.stepDefinitions" }, 
		tags = {"@CheckIn_MultipaxBooking" }, 
		monochrome = true, 
		plugin = { "pretty", "pretty:target/cucumber-report/Smoke/pretty.txt",
